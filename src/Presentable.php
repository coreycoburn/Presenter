...
trait Presentable
{
     ...
     *
     * Also, ensure that your presenter name is in the convension of ModelPresenter. i.e. UserPresenter.
     *
    ...
    public function present()
    {
        ...
        if (!class_exists($this->presenter)) {
            throw new PresenterException('Invalid Presenter class. Use convenstion i.e. UserPresenter. Yours was: ' . $this->presenter);
        }
